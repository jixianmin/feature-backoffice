...
const SearchModal = ({ show, handleClose }) => {
    return (<Modal className='bg-body' id='kt_header_search_modal' aria-hidden='true' dialogClassName='modal-fullscreen h-auto' show={show}>
                    ...
                    <div className='col-sm-6'>
                      <div className='card card-custom overlay min-h-125px mb-5 shadow-none'>
                        <div className='card-body d-flex flex-column p-0'>
                          <div className='overlay-wrapper flex-grow-1 bgi-no-repeat bgi-size-cover bgi-position-center card-rounded' style={{
