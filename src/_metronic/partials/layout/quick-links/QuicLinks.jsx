...
const QuickLinks = () => (<div className='menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px' data-kt-menu='true'>
    <div className='d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10' style={{ backgroundImage: `url('${toAbsoluteUrl('/media/misc/pattern-1.jpg')}')` }}>
    ...
    <div className='row g-0'>
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom'>
          <KTSVG path='/media/icons/duotune/finance/fin009.svg' className='svg-icon-3x svg-icon-primary mb-2'/>
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom'>
          <KTSVG path='/media/icons/duotune/communication/com010.svg' className='svg-icon-3x svg-icon-primary mb-2'/>
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end'>
          <KTSVG path='/media/icons/duotune/abstract/abs042.svg' className='svg-icon-3x svg-icon-primary mb-2'/>
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light'>
          <KTSVG path='/media/icons/duotune/finance/fin006.svg' className='svg-icon-3x svg-icon-primary mb-2'/>
