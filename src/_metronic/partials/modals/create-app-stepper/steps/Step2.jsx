const Step2 = ({ data, updateData }) => {
    return (<div className='pb-5' data-kt-stepper-element='content'>
      <div className='w-100'>
        {/*begin::Form Group */}
        <div className='fv-row'>
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input className='form-check-input' type='radio' name='appFramework' value='HTML5' checked={data.appFramework === 'HTML5'} onChange={() => updateData({ appFramework: 'HTML5' })}/>
            </span>
          </label>
          {/*end::Option */}
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input className='form-check-input' type='radio' name='appFramework' value='ReactJS' checked={data.appFramework === 'ReactJS'} onChange={() => updateData({ appFramework: 'ReactJS' })}/>
            </span>
          </label>
          {/*end::Option */}
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input className='form-check-input' type='radio' name='appFramework' value='Angular' checked={data.appFramework === 'Angular'} onChange={() => updateData({ appFramework: 'Angular' })}/>
            </span>
          </label>
          {/*end::Option */}
          ...
          <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
            ...
            <span className='form-check form-check-custom form-check-solid'>
              <input className='form-check-input' type='radio' name='appFramework' value='Vue' checked={data.appFramework === 'Vue'} onChange={() => updateData({ appFramework: 'Vue' })}/>
            </span>
          </label>
          {/*end::Option */}
        </div>
