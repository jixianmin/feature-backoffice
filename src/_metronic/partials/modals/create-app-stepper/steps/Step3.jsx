const Step3 = ({ data, updateData, hasError }) => {
    return (<>
      {/*begin::Step 3 */}
      <div className='pb-5' data-kt-stepper-element='content'>
        <div className='w-100'>
          ...
          <div className='fv-row mb-10'>
            ...
            <input type='text' className='form-control form-control-lg form-control-solid' name='dbname' value={data.appDatabase.databaseName} onChange={(e) => updateData({
            appDatabase: {
                databaseName: e.target.value,
                databaseSolution: data.appDatabase.databaseSolution,
            },
        })}/>
            {!data.appDatabase.databaseName && hasError && (<div className='fv-plugins-message-container'>
          ...
          <div className='fv-row'>
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input className='form-check-input' type='radio' name='databaseSolution' value='MySQL' checked={data.appDatabase.databaseSolution === 'MySQL'} onChange={() => updateData({
            appDatabase: {
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input className='form-check-input' type='radio' name='databaseSolution' value='Firebase' checked={data.appDatabase.databaseSolution === 'Firebase'} onChange={() => updateData({
            appDatabase: {
                databaseName: data.appDatabase.databaseName,
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input className='form-check-input' type='radio' name='databaseSolution' value='DynamoDB' checked={data.appDatabase.databaseSolution === 'DynamoDB'} onChange={() => updateData({
            appDatabase: {
                databaseName: data.appDatabase.databaseName,
