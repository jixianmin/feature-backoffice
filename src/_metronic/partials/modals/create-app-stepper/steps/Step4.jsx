          ...
          <div className='fv-row'>
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input className='form-check-input' type='radio' name='appStorage' value='Basic Server' checked={data.appStorage === 'Basic Server'} onChange={() => updateData({ appStorage: 'Basic Server' })}/>
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input className='form-check-input' type='radio' name='appStorage' value='AWS' checked={data.appStorage === 'AWS'} onChange={() => updateData({ appStorage: 'AWS' })}/>
              </span>
            </label>
            {/*end::Option */}
            ...
            <label className='d-flex align-items-center justify-content-between cursor-pointer mb-6'>
              ...
              <span className='form-check form-check-custom form-check-solid'>
                <input className='form-check-input' type='radio' name='appStorage' value='Google' checked={data.appStorage === 'Google'} onChange={() => updateData({ appStorage: 'Google' })}/>
              </span>
            </label>
            {/*end::Option */}
          </div>
